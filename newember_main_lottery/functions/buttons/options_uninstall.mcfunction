...
execute as @s[tag=nwbr_classic] at @s positioned ~ ~1 ~ run function newember_main_lottery:spawn/summon/item_classic
execute as @s[tag=nwbr_ender] at @s positioned ~ ~1 ~ run function newember_main_lottery:spawn/summon/item_ender
execute as @s[tag=nwbr_fancy] at @s positioned ~ ~1 ~ run function newember_main_lottery:spawn/summon/item_fancy
execute as @s[tag=nwbr_goldmine] at @s positioned ~ ~1 ~ run function newember_main_lottery:spawn/summon/item_goldmine
execute as @s[tag=nwbr_special] at @s positioned ~ ~1 ~ run function newember_main_lottery:spawn/summon/item_special
...
execute at @s run kill @e[tag=nwbr_disp_lot,distance=..2]
