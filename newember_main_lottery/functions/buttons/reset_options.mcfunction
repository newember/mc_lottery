########## button reset ##########
execute as @s[tag=nwbr_east,tag=!nwbr_special] run setblock ~ ~ ~ minecraft:crimson_button[facing=west]
execute as @s[tag=nwbr_north,tag=!nwbr_special] run setblock ~ ~ ~ minecraft:crimson_button[facing=south]
execute as @s[tag=nwbr_west,tag=!nwbr_special] run setblock ~ ~ ~ minecraft:crimson_button[facing=east]
execute as @s[tag=nwbr_south,tag=!nwbr_special] run setblock ~ ~ ~ minecraft:crimson_button[facing=north]
