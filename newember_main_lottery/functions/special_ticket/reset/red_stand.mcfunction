execute in newember_ultra_vfx:red positioned ~ 5 ~ run fill ^-1 ^2 ^1 ^ ^2 ^-1 air
execute in newember_ultra_vfx:red positioned ~ 5 ~ run fill ^-1 ^1 ^1 ^ ^1 ^-1 air
execute in newember_ultra_vfx:red positioned ~ 5 ~ run fill ^-1 ^ ^1 ^ ^ ^-1 air
