...
execute at @a if score @p nwbr_player_id = @p nwbr_player_id run effect give @p minecraft:strength 999999 0 true
execute at @a if score @p nwbr_player_id = @p nwbr_player_id run effect give @p minecraft:slowness 999999 0 true
execute at @a if score @p nwbr_player_id = @p nwbr_player_id run effect give @p minecraft:bad_omen 999999 0 true
execute at @a if score @p nwbr_player_id = @p nwbr_player_id run effect give @p minecraft:unluck 999999 0 true
execute at @a if score @p nwbr_player_id = @p nwbr_player_id run effect give @p minecraft:blindness 20 0 true
