...
execute as @s[tag=nwbr_goldmine] if score #5 nwbr_lot_score matches 3 at @a if score @p nwbr_player_id = @s nwbr_player_id run scoreboard players add @p nwbr_lwin_go05 1
