...
execute if entity @s[tag=nwbr_stand_near] run function newember_main_lottery:spawn/summon/item_classic
...
execute if entity @s[scores={nwbr_number=2..}] run function newember_main_lottery:spawn/summon/item_classic

execute as @s[tag=!nwbr_stand_near,scores={nwbr_number=..1}] as @p run function newember_main_lottery:spawn/create/classic/stand
