...
execute if entity @s[tag=nwbr_stand_near] run function newember_main_lottery:spawn/summon/item_fancy
...
execute as @s[tag=!nwbr_stand_near,scores={nwbr_number=..1}] as @p run function newember_main_lottery:spawn/create/fancy/stand
