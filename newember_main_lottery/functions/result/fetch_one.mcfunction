...
execute as @e[tag=nwbr_special,tag=!nwbr_ultra,distance=..2] run scoreboard players set in1 math 15
execute as @e[tag=nwbr_special,tag=nwbr_ultra,distance=..2] run scoreboard players set in1 math 3
