...
execute if predicate newember_skins:evolution_skin/dengeki_drive_b if score @s nwbr_math2 matches 1 run tellraw @s ["",{"text":"Votre skin a régressé en ","color":"#9D7551"},{"text":"[","bold":true,"italic":true,"color":"#FFC61A"},{"text":"Dengeki Drive B","bold":true,"italic":true,"color":"#FFC61A"},{"text":"]","bold":true,"italic":true,"color":"#FFC61A"}]

#finalisation
item modify entity @s armor.chest newember_skins:skin_upgrade
playsound minecraft:ui.stonecutter.take_result block @s ~ ~ ~ 1 2