...
data modify entity @s Item.tag.nbrData.skinMaxLevel set from entity @e[limit=1,sort=nearest,predicate=newember_skins:is_skin_modifier] Item.tag.nbrData.skinMaxLevel
data modify entity @s Item.tag.nbrData.skinEvoType set from entity @e[limit=1,sort=nearest,predicate=newember_skins:is_skin_modifier] Item.tag.nbrData.skinEvoType
data modify entity @s Item.tag.nbrData.skinProgress set from entity @e[limit=1,sort=nearest,predicate=newember_skins:is_skin_modifier] Item.tag.nbrData.skinProgress
