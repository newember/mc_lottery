...
execute as @s[tag=nwbr_special] store result score @s nwbr_number run scoreboard players operation @s nwbr_number *= #3 nwbr_number
execute as @s[tag=nwbr_skin] store result score @s nwbr_number run scoreboard players operation @s nwbr_number *= #2 nwbr_number
