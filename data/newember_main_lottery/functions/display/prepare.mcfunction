...
execute as @s[tag=nwbr_skin] run scoreboard players operation @e[distance=..1.5,tag=nwbr_disp_lot,scores={nwbr_lot_score=-1}] nwbr_no_itm_disp %= #175 nwbr_number
...
execute as @s[tag=nwbr_skin] as @e[distance=..1.5,tag=nwbr_disp_lot,scores={nwbr_lot_score=-1}] run function newember_main_lottery:display/skin/merge_item
