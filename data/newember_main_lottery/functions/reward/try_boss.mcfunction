...
execute if score @s rng_lcg_out <= @s nwbr_number at @a[distance=..40] if score @p nwbr_player_id = @s nwbr_player_id run advancement grant @p only newember_main_lottery:lotterie/missf_g_summon
